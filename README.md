...
| 09/10/2024 | **Inverted Indexes. TAAT and DAAT**. (RV)<br><br>Inverted indexes for boolean and ranked retrieval. Term-at-a-time (TAAT) and Document-at-a-time. NextGEQ operation with binary search and skip pointers. Faster AND query with nextGEQ. Positional Indexes for Phrase queries.<br><br>*Reference*: Sections 1 and 2.2 in *Efficient Query Processing for Scalable Web Search*, Nicola Tonellotto, Craig Macdonald, and Iadh Ounis, Now Foundations and Trends, 2018. ([link](https://arpi.unipi.it/retrieve/e0d6c931-3b36-fcf8-e053-d805fe0aa794/main-nowplain.pdf)) |
