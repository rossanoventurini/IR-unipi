...
| 16/10/2024 | **Query Processing**. (RV)<br><br>Top-k retrieval. Exhaustive OR query and Min-Heap. WAND and Max-score. Intuition of blocking: Block Max-WAND and Block Max-Score.<br><br>*Reference*: Section 3 in *Efficient Query Processing for Scalable Web Search*, Nicola Tonellotto, Craig Macdonald, and Iadh Ounis, Now Foundations and Trends, 2018. ([link](https://arpi.unipi.it/retrieve/e0d6c931-3b36-fcf8-e053-d805fe0aa794/main-nowplain.pdf)) |
